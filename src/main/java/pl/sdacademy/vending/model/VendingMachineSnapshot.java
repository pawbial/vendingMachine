...
public class VendingMachineSnapshot {
    ...
    private VendingMachineSnapshot(Builder builder, int rows, int cols) {
        this.trays = builder.trays;
        this.rows = builder.rows;
        this.cols = builder.cols;
    }

    public static Builder build (int rows, int cols) {
    ...
    public static class Builder {
        ...
        public VendingMachineSnapshot build () {
            return new VendingMachineSnapshot(this, rows, cols);
        }
